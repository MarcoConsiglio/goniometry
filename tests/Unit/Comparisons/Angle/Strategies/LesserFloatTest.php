...
class LesserFloatTest extends StrategiesTestCase
{
    ...
    public function test_compare(): void
    {
        ...
        $beta = $this->positiveRandomSexadecimal(min: 180);
        ...
        $beta = $this->randomSexadecimal(NextFloat::after(-180), NextFloat::before(180));
