...
class GreaterOrEqualTest extends TestCase
{
    ...
    {
        // Act & Assert
        $comparison = new GreaterOrEqual($this->alfa, $this->beta);
    ...
    {
        // Act & Assert
        $comparison = new GreaterOrEqual($this->alfa, $this->randomDegrees()->value());
        $this->assertIsBool($comparison->compare());
    }
    ...
    {
        // Act & Assert
        $comparison = new GreaterOrEqual($this->alfa, (string) $this->beta);
        $this->assertIsBool($comparison->compare());       
    }
}