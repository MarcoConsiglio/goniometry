...
abstract class TestCase extends BaseTestCase
{
    ...
    protected (AngularDistance&Stub)|float|int|string $beta;
    ...
    abstract protected function getBeta(): (AngularDistance&Stub)|float|int|string;
     ...
     * 
     * @throws Error if `$input_type_class` is not a valid class.
     */
